...
We shall now use a different dataset 'birds' and apply our newly developed package to the dataset to demonstrate the functionality of umapgp in the cluster/species orientation. We shall also draw comparisons between the UMAP plots created using the umap and the umapgp functions. 
...
3. https://towardsdatascience.com/why-umap-is-superior-over-tsne-
faa039c28e99
